        ...
        <footer>
            <div className="item">
                <div className="box-column">
                    ...
                    <div className="box-reference">
                        <div className="reference-msg">
                            <a
                                href="mailto: oicovidrn@gmail.com"
                                style={{ color: 'inherit' }}
                            >
                                Contato: EMAIL
                            </a>
                        ...
                        <div className="reference-icon">
                            <a
                                ...
                                style={{ color: 'inherit' }}
                            >
                                <FaEnvelope size={14} color="#353244" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div className="item">
                <div className="box-column">
                    <img
                        src={icon}
                        alt="logomarca COVID-RN"
                        style={{ width: 64, height: 64 }}
                    />
                    <div className="box-info">
                        <span>© 2020 COVID-RN</span>
                        <span>Release v1.1290</span>
                    </div>
                </div>
            </div>
        </footer>
